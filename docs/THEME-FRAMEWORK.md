...
| **Components**  | `--card`, `--card-foreground`, `--popover`, `--popover-foreground`, `--modal`, `--modal-foreground`, `--dropdown`, `--dropdown-foreground`, `--sheet`, `--sheet-foreground`, `--tabs`, `--input-surface`, `--primary`, `--primary-foreground`, `--secondary`, `--secondary-foreground`, `--muted`, `--muted-foreground`, `--accent`, `--accent-foreground`, `--destructive`, `--destructive-foreground` |
