const INTEGRATIONS = [
  {
    name: 'Gmail',
    desc: 'Send outreach directly from your inbox',
    logo: (
  ...
  {
    name: 'Apollo',
    desc: 'Discover contacts with verified emails',
    logo: (
      <svg viewBox="0 0 24 24" className="size-5" fill="currentColor">
  ...
  {
    name: 'Anthropic',
    desc: 'AI research and personalized outreach',
    logo: (
      <svg viewBox="0 0 24 24" className="size-5" fill="currentColor">
  ...
  {
    name: 'OpenAI',
    desc: 'Signal detection and content analysis',
    logo: (
      <svg viewBox="0 0 24 24" className="size-5" fill="currentColor">
  ...
  {
    name: 'LinkedIn',
    desc: 'Track posts and profile changes',
    logo: (
      <svg viewBox="0 0 24 24" className="size-5" fill="currentColor">
  ...
  {
    name: 'Crunchbase',
    desc: 'Funding rounds and company data',
    logo: (
      <svg viewBox="0 0 24 24" className="size-5" fill="currentColor">
  ...
  {
    name: 'Google',
    desc: 'OAuth and workspace integrations',
    logo: (
      <svg viewBox="0 0 24 24" className="size-5" fill="currentColor">
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-4">
        {INTEGRATIONS.map((integration) => (
          <div
            ...
            className="group flex items-start gap-3 rounded-xl border border-white/6 bg-white/2 px-4 py-4 transition-all duration-300 hover:border-white/10 hover:bg-white/3"
          >
            <div className="flex size-8 shrink-0 items-center justify-center rounded-lg bg-white/5 text-white/60 transition-colors duration-300 group-hover:bg-white/8 group-hover:text-white/90">
              {integration.logo}
            </div>
            <div className="min-w-0">
              <span className="text-landing-fg block text-sm font-medium">{integration.name}</span>
              <span className="text-landing-fg-muted block text-xs leading-snug">
                {integration.desc}
              </span>
            </div>
          </div>
